  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: 'var(--foreground)', margin: '0 0 6px' }}>Trilha de Aprendizado</h1>
          <p style={{ fontSize: 13, color: 'var(--muted-foreground)' }}>{steps?.length ?? 0} etapas cadastradas</p>
        </div>
