  ...
  return (
    <div>
      ...
      {!isAdmin && hasNoContent && !(completed || userProgress?.status === 'concluido') && (
        <div style={{ background:'var(--card)', border:'1.5px solid rgba(99,102,241,.25)', borderRadius:16, padding:'22px', marginBottom:16, textAlign:'center', boxShadow:'0 2px 12px rgba(99,102,241,.08)' }}>
          ...
          <button onClick={completeEmptyStep} disabled={completing}
            style={{ height:46, padding:'0 32px', borderRadius:12, background:completing?'var(--secondary)':'linear-gradient(135deg,#4f46e5,#7c3aed)', color:completing?'var(--muted-foreground)':'#fff', fontSize:14, fontWeight:800, border:'none', cursor:completing?'not-allowed':'pointer', fontFamily:'inherit', boxShadow:completing?'none':'0 4px 16px rgba(79,70,229,.35)', display:'inline-flex', alignItems:'center', gap:8 }}>
      ...
      {!isAdmin && hasNoContent && (completed || userProgress?.status === 'concluido') && (
        <div style={{ background:'rgba(34,197,94,.06)', border:'1px solid rgba(34,197,94,.25)', borderRadius:14, padding:'14px 18px', marginBottom:16, display:'flex', alignItems:'center', justifyContent:'space-between', gap:12, flexWrap:'wrap' }}>
          ...
          <button onClick={handleNextStep}
            style={{ height:36, padding:'0 18px', borderRadius:9, background:'linear-gradient(135deg,#22c55e,#16a34a)', color:'#fff', border:'none', cursor:'pointer', fontSize:13, fontWeight:700, fontFamily:'inherit', display:'flex', alignItems:'center', gap:6 }}>
